    ...
    <div style={{ minHeight: '100vh', background: '#000', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px 16px' }}>
        <div style={{
          ...
          <h1 style={{ fontSize: '22px', fontWeight: 600, marginBottom: '4px', color: '#1c1917' }}>Welcome back</h1>
          <p style={{ fontSize: '14px', color: '#78716c', marginBottom: '24px' }}>Sign in to your account to continue</p>
          ...
          <button
            ...
            style={{
              ...
              gap: '10px', padding: '10px', background: '#fff', border: '1px solid #d6d3d1',
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: '14px' }}>
              <label style={{ display: 'block', fontSize: '13px', fontWeight: 500, color: '#44403c', marginBottom: '6px' }}>
                Email
              </label>
              <input
                ...
                style={{
                  ...
                  borderRadius: '8px', fontSize: '14px', color: '#1c1917',
            ...
            <button
              type="submit"
              style={{
                width: '100%', padding: '10px', background: '#1c1917', color: '#fff',
